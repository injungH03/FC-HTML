...
<table>
    ...
    <tbody>
        <tr>
            <td><code>serif</code></td>
            <td>바탕체 계열</td>
            <td style="font-family:'Times New Roman', Times, serif">Hello World!</td>
        </tr>
        <tr>
            <td><code>sans-serif</code></td>
            <td>고딕체 계열</td>
            <td style="font-family: Arial, Helvetica, sans-serif">Hello World!</td>
        </tr>
        <tr>
            <td><code>monospace</code></td>
            <td>고정너비(가로폭이 동등한) 글꼴 계열</td>
            <td style="font-family: 'Courier New', Courier, monospace">Hello World!</td>
        </tr>
        <tr>
            <td><code>cursive</code></td>
            <td>필기체 계열</td>
